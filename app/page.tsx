    ...
    <div style={{ 
      ...
      <section className="fixed top-0 left-0 bottom-0 w-full h-full flex justify-center px-5 pt-10
        ...
        <div className="w-full max-w-[30rem] flex flex-col mb-auto mt-8">
          <div className='p-10 bg-[#f9f9f9]/90'>
            <div>
            ...
            <div className='mt-[1rem]'>
              <p className='text-[#454545] text-[13px] md:max-w-sm leading-[1.4rem] md:leading-[1.8rem]'>
              ...
              <p className='text-[#454545] text-[13px] mt-[1rem] md:max-w-sm leading-[1.4rem] md:leading-[1.8rem]'>
