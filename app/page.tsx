...
const Page = () => {
  return (
    <div className="fixed top-0 left-0 w-screen h-screen overflow-hidden">
      ...
      {/* Content scaled on mobile to fit */}
      <section
        className="absolute top-0 left-0 w-full h-full flex justify-center items-center
                   px-5 md:justify-end md:pr-10 "
      >
        <div
          className="w-full max-w-[30rem] flex flex-col mb-auto mt-4
                     scale-[0.65] sm:scale-[0.75] md:scale-100 origin-top"
        >
          <div className="p-5 bg-[#f9f9f9]/90">
            <div>
          ...
          <div className="py-3 flex justify-start">
            <TransitionLink href="/category/clothing">
              <button
                className="text-[13px] text-[#fff] bg-[rgb(7,7,7)]
